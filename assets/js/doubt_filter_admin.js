...
for(let filterElement of filterSubject){
    filterElement.addEventListener('click',function(e){
        ...
        window.location.href="/content/doubts/?sub="+subjectQuery+"&date="+sortQuery+"&branch=All";
    });
}
...
for(let filterElement of filterSort){
    filterElement.addEventListener('click',function(e){
        ...
        window.location.href="/content/doubts/?sub="+subjectQuery+"&date="+sortQuery+"&branch="+classQuery;
    });
}
