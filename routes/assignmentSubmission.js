...
//ajax calls
Router.post('/create/:assignmentId', upload.array(),contentController.assignmentSubmissionCreate);
Router.post('/update/:assignmentId',contentController.assignmentSubmissionUpdate);
